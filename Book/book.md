...
pandoc -s book.md --pdf-engine=xelatex -o book_xelatex.pdf --from markdown --template="eisvogel.tex"
pandoc -s book.md --pdf-engine=lualatex -o book_lualatex.pdf --from markdown --template="eisvogel.tex"
