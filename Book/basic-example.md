...
pandoc -s basic-example.md --pdf-engine=xelatex -o basic-exemple_xelatex.pdf --from markdown --template="eisvogel.tex"
pandoc -s basic-example.md --pdf-engine=lualatex -o basic-exemple_lualatex.pdf --from markdown --template="eisvogel.tex"
