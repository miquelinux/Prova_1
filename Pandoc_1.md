...
pandoc -s Pandoc_1.md --variable="vmargin:1cm" --variable="hmargin:1cm" -V papersize="A5" --pdf-engine=lualatex -o Pandoc_0.pdf
...
pandoc -N --template=template-pandoc.tex --variable papersize="A4" --variable mainfont="Linux Libertine G" --variable sansfont="DejaVu Sans" --variable monofont="DejaVu Sans Mono" --variable fontsize=12pt --variable version=2.0 Pandoc_1.md --pdf-engine=xelatex --toc -o Pandoc_1_xelatex_A4.pdf
